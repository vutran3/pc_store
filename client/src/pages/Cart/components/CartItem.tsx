    ...
    <div className="flex gap-4 p-4 bg-white rounded-lg border border-gray-200 hover:shadow-md transition-shadow items-center">
      ...
      <div className="flex-1">
        ...
        <div className="flex items-center gap-3">
          <span className="text-lg font-bold text-blue-600">{formatPrice(item.product.priceAfterDiscount)}</span>
          {typeof item.product.originalPrice === 'number' && item.product.originalPrice > item.product.priceAfterDiscount && (
